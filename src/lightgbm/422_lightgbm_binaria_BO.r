...
# contar numero de hiperparametros
# num_hs <- length(hs$pars)

# iteraciones dinamics basadas en hiperparametros
# PARAM$hyperparametertuning$iteraciones <- max(150, 20 * num_hs)
